...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get infoPlaceholderText =>
      'What Is Promilaj?\\nPromilaj is a tool that estimates your blood alcohol concentration (BAC) using the Widmark formula. It shows the legal limits for your country and estimates when you can safely drive again.\\n\\nPlease Note\\nNever drive under the influence of alcohol. This app is not a substitute for a breathalyzer; it provides estimates only. When in doubt, always wait.\\n\\nLocation Permission\\nWe use your location to automatically display the legal alcohol limit for your country. Your location stays on your device and is never sent to any server.\\n\\nWhy Do We Ask for This Information?\\nYour weight, height, and the type of drink you consumed directly affect your blood alcohol level. The information you enter is used solely for calculation and is never stored or shared.\\n\\nBiological Sex vs. Gender\\nThe Widmark formula is based on body water and fat ratios, so it asks for your biological sex (male/female). This question is not about your gender identity; it is used only for metabolic calculation.\\n\\nWhat Is Promille (‰)?\\nPromille means per thousand. A BAC of 1‰ means 1 gram of alcohol per 1,000 grams of blood. Promille is used instead of percent because blood alcohol levels are expressed in very small amounts.\\n\\nLegal Disclaimer\\nThis app is for informational purposes only. The values provided are estimates; your actual blood alcohol level may differ. Age, medication, food intake, and genetic factors affect each individual\'s metabolism differently. Use a certified breathalyzer before making any legal decision. The developer and this application cannot be held responsible for any decisions made based on this information.';
